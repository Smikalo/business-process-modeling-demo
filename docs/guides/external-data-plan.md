...
A source is **DROPPED** if none of the above hold. Decisions are summarized per-source in [`docs/external-data-sources.md`](../external-data-sources.md) and the per-loader files under [`src/loaders/`](../../src/loaders/).
